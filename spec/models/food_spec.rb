...
RSpec.describe Food, type: :model do
  ...
  let!(:simple_cake) { Recipe.create(name: "Simple cake", description: 'This is simple cake recipe', preparation_time: '1 hour', cooking_time: '1.5 hours', public: true, user: ellon) }
